...
def on_input(msg):
    ...
    att["table"] = {"columns": [
        ...
        {"class": str(tdf[tdf.columns[3]].dtype), "tdf_name": tdf.columns[3], "name": "INTERVAL_WIDTH", "nullable": True,"type": {"hana": "INTEGER"}},
        {"class": str(tdf[tdf.columns[4]].dtype), "tdf_name": tdf.columns[4], "name": "TIMESTAMP_START","nullable": True, "type": {"hana": "LONGDATE"}},
        {"class": str(tdf[tdf.columns[5]].dtype), "tdf_name": tdf.columns[5], "name": "TIMESTAMP_END", "nullable": True,"type": {"hana": "LONGDATE"}},
        {"class": str(tdf[tdf.columns[6]].dtype), "tdf_name": tdf.columns[6], "name": "POWER_MIN", "nullable": True,"type": {"hana": "DOUBLE"}},
        {"class": str(tdf[tdf.columns[7]].dtype), "tdf_name": tdf.columns[7], "name": "POWER_MAX", "nullable": True,"type": {"hana": "DOUBLE"}},
        {"class": str(tdf[tdf.columns[8]].dtype), "tdf_name": tdf.columns[8], "name": "POWER_MEAN", "nullable": True,"type": {"hana": "DOUBLE"}},
        {"class": str(tdf[tdf.columns[9]].dtype), "tdf_name": tdf.columns[9], "name": "HEARTRATE_MIN","nullable": True, "type": {"hana": "INTEGER"}},
        {"class": str(tdf[tdf.columns[10]].dtype), "tdf_name": tdf.columns[10], "name": "HEARTRATE_MAX","nullable": True, "type": {"hana": "INTEGER"}},
        {"class": str(tdf[tdf.columns[11]].dtype), "tdf_name": tdf.columns[11], "name": "HEARTRATE_MEAN","nullable": True, "type": {"hana": "INTEGER"}},
        {"class": str(tdf[tdf.columns[12]].dtype), "tdf_name": tdf.columns[12], "name": "CADENCE_MIN", "nullable": True,"type": {"hana": "DOUBLE"}},
        {"class": str(tdf[tdf.columns[13]].dtype), "tdf_name": tdf.columns[13], "name": "CADENCE_MAX", "nullable": True,"type": {"hana": "DOUBLE"}},
        {"class": str(tdf[tdf.columns[14]].dtype), "tdf_name": tdf.columns[14], "name": "CADENCE_MEAN","nullable": True, "type": {"hana": "DOUBLE"}}], "name": "BEST_INTERVAL", "version": 1}
